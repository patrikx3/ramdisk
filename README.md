...
# 💾 Linux RAM disk persistent with Systemd timer, service and suspend v2019.4.112  
...
![http://sheroz.com/pages/blog/improving-development-performance-moving-intellij-idea-cache-ramdisk.html](./artifacts/original-idea.png "After all these tricks I tried to open my current project with IntelliJ IDEA 12 …")  
...
[**P3X-RAMDISK**](https://pages.corifeus.com/ramdisk) Build v2019.4.112 
